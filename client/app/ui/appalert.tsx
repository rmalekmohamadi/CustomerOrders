...
export const AppAlert: React.FC<{ condition: boolean, title?: string, message?: string, icon?: FC<ComponentProps<"svg">>, color?: keyof FlowbiteColors, className?: string, children?: ReactNode }> = 
