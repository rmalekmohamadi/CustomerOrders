...
import { updateOrder } from "@/app/libs/actions";
...
export default function EditOrderForm({
    ...
    const formAction = handleSubmit(async ({ id, customername, address, date, items }) => {
        ...
        const newOrder: OrderModel = { id: order.id, customername: customername, address: address, date: date, items: productItems };
        const res = await updateOrder(order.id, newOrder);
        ...
        if(res != null && res.succeed)
            ...
            toast.success('Failed to edit order'); 
        }
    });
...
//   const [state, dispatch] = useFormState(createInvoice, initialState);
    ...
    <div>
        <div className="max-w-md">
            ...
            <TextInput id="customerName" color={errors.customername ? "failure" : "gray"} defaultValue={order.customername}
        ...
        <div className="max-w-md">
            ...
            <TextInput id="address" color={errors.address ? "failure" : "gray"} defaultValue={order.address}
        ...
        <div className="max-w-md">
            ...
            <Select id="items" multiple color={errors.items ? "failure" : "gray"} defaultValue={order.items?.map(e => e.id.toString())}
    ...
    <div className="row mt-4">
        <Button type="submit" color="gray">Update Order</Button>
    </div>
</form>
  }
